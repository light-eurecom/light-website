...
const features = [
  {
    ...
    description:
      'Maximizing network resources for seamless content delivery.',
    icon: DeviceChartIcon,
  },
  {
    name: 'Low delay',
    description:
      'Reducing VoD delay for all users at peak hours.',
    icon: DeviceClockIcon,
  },
  {
    name: 'Scalability',
    description:
      'Serving numerous users simultaneously with no compromise in VoD quality.',
        ...
        >
          {features.map((feature) => (
            ...
            >
              ...
              <p className="mt-2 opacity-75">{feature.description}</p>
            </li>
          ))}
        </ul>
        <div className="mx-auto mt-24 sm:text-center">
          <dl className="col-span-2 grid grid-cols-1 gap-x-8 gap-y-10 text-base leading-7 sm:grid-cols-2 lg:gap-y-16">
            <div className="relative pl-9">
              ...
              <dd className="mt-2 text-left">Light VoD has <span className='italic font-bold'>simplicity</span> at its core: revolutionizes content delivery using existing infrastructure, technologies, protocols, processes.
              </dd>
            </div>
            <div className="relative pl-9">
              <dt className="font-semibold">
              ...
              <dd className="mt-2 text-left" >
                Light VoD makes <span className='italic font-bold'>caching</span> and <span className='italic font-bold'>multicasting</span> work together to experience unprecedented network gains.
