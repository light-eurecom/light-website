export const types = ["Text", "Video"] as const
...
export const models: Model<ModelType>[] = [
  {
    ...
    name: "Short text transmission",
    description:
      "Short text transmission simulation.",
    type: "Text",
  },
  {
    id: "c305f976-8e38-42b1-9fb7-d21b2e34f0db",
    name: "Long text transmission",
    description:
      "Long text transmission simulation.",
    type: "Text",
  },
  {
    id: "c305f976-8e38-42b1-9fb7-d21b2e34f0dc",
    name: "Simple video transmission",
    description:
      "Simple video transmission simulation.",
    type: "Video",
  }
  // {
